      ...
      <section className="bg-white py-16 px-4 md:px-10 lg:px-20">
        ...
        >
            ...
            {[
              {
                title: "Our History",
                content:
                  "Since our founding in 2008, AJOCREMAY MEDICARE has grown from a single classroom into a full-fledged learning institution, impacting thousands of lives.",
              },
              {
          ...
          <motion.div className="mt-16 text-left" variants={fadeInUp}>
            ...
            <ul className="text-gray-700 list-disc pl-5 space-y-2">
              <li>
                <strong>Excellence</strong> – We strive for the highest standards in academics and service.
              </li>
              <li>
                <strong>Integrity</strong> – We uphold truth, honesty, and transparency in all we do.
              </li>
              <li>
                <strong>Empathy</strong> – We nurture kindness and compassion in our learners and staff.
              </li>
              <li>
                <strong>Innovation</strong> – We embrace change and empower creativity through technology and curiosity.
              </li>
              <li>
                <strong>Discipline</strong> – We encourage respect, responsibility, and good character.
              </li>
            </ul>
          </motion.div>
