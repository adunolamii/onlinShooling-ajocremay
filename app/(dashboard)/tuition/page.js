   ...
   <section className="bg-green-100 py-16 px-4">
      ...
      >
        ...
        <motion.p
          ...
          variants={itemVariants}
        >
          We offer flexible and affordable tuition for all our programs to help you reach your healthcare goals.
        </motion.p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8">
          {tuitionPlans.map((plan, index) => (
            <motion.div
              ...
              variants={itemVariants}
            >
              <h3 className="text-2xl font-semibold text-green-800 mb-2">{plan.program}</h3>
              <p className="text-sm text-gray-600 mb-2">
                Duration: <span className="font-medium">{plan.duration}</span>
              </p>
              <p className="text-xl text-red-600 font-bold mb-2">{plan.tuition}</p>
